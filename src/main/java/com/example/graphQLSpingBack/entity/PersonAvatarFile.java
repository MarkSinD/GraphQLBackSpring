...
import com.example.graphQLSpingBack.exception.InvalidPersonAvatarException;
import com.example.graphQLSpingBack.properties.Dimensions;
...
public class PersonAvatarFile {
    ...
    public PersonAvatarFile(Part file, int personId, Clock clock) throws IOException {
